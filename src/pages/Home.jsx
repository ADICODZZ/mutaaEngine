    ...
    <div>
      <div className="flex flex-col lg:flex-row w-full items-center justify-center text-white py-16 lg:py-24">
        ...
        <div className="relative mx-2 flex flex-col items-start justify-between w-full lg:w-[50%]">
          {/* Tagline Button */}
          <div className="group mx-auto lg:mx-0 mb-8 w-fit rounded-2xl bg-[#00040F] p-1 font-bold text-white drop-shadow-[0_-3px_5px_rgba(135,206,235,0.7)] transition-all duration-200 ">
  <div className="flex flex-row items-center gap-2 rounded-lg px-10 py-[5px] transition-all duration-200 ">
    <p>Protecting Code, Preserving Innovation</p>
          ...
          <div className="mt-8 flex flex-row gap-6">
            <CTAButton
              active={true}
              linkto={"/signup"}
              className="px-8 py-3 bg-[#3ED5DD] hover:bg-opacity-80 text-black font-bold rounded-lg transition-all"
            >
              Learn More
            </CTAButton>
            <CTAButton
              active={false}
              linkto={"/login"}
              className="px-8 py-3 border border-white text-white bg-[#00040F] hover:bg-[#00d8ff] hover:text-black font-bold rounded-lg transition-all"
            >
              Start Now
            </CTAButton>
          </div>
